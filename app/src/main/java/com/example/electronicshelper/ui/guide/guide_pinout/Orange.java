...
public class Orange extends AppCompatActivity implements SubItemAdapter.OnSubItemListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.title_activity_orange);

    }

    int[] raspberry = {
            R.drawable.png_orange_pi_zero
    };
    ...
    private List<SubItem> buildSubItemList() {
        ...
        subItem = new SubItem(raspberry[0], "Orange Pi", "Zero");
    ...
    int[] imgRaspberry = {
            R.drawable.img_orange_pi_pinout_zero
    };
