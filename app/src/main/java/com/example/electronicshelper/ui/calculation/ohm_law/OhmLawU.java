...
public class OhmLawU extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvOhmF.setText(R.string.ohm_law_f_u);
        tvOhm0.setText(R.string.ohm_law_v);
        tvOhm1.setText(R.string.ohm_law_i);
        ...
        btnCalc.setOnClickListener(view -> {
            try{
                if (TextUtils.isEmpty(etU.getText().toString())
                    ...
                    i = Double.parseDouble(etU.getText().toString());
