...
public class SerialC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvReF.setText(R.string.serial_c);
        tvReCI.setText(R.string.div_u_c1);
        tvReCF.setText(R.string.div_u_c2);
        tvOhm0.setText(R.string.micro_f);
